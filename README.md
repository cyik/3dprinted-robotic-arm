...
Issues:  
During initial homing test, the robot arm showed noticeable backlash in JOINT 3, leading me to believe the output shaft is slipping.

Fixes:  
Set screws on flange couplers need to be tightened with loctite to avoid slipping with the motor output shaft.
...
Fixes:  
Buy higher quality 1:20 Planetary Gearbox with less backlash.
